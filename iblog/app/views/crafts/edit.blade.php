...
<h2 class="edit-craft">
    {{ trans('messages.Edit').' '.Lang::choice('messages.Crafts', 1); }}
    <span class="right">{{ HTML::linkRoute('craft.list',trans('messages.Cancel'),null,['class' => 'button tiny radius']) }}</span>
</h2>
<hr>
{{ Form::open(['route'=>[ 'craft.update',$craft->id], 'files'=>true, 'id'=>'comment']) }}
<div class="row">
    <div class="small-5 large-5 column">
        {{ Form::label('title', trans('messages.Craft title').':') }}
        {{ Form::text('title',Input::old('title',$craft->title)) }}
    </div>
</div>
<div class="row">
    <div class="small-7 large-7 column">
        {{ Form::label('description',trans('messages.Description').':') }}
        {{ Form::textarea('description',Input::old('description',$craft->description),['rows'=>5]) }}
    </div>
</div>
<div class="row">
    <div class="small-5 large-5 column">
        {{ Form::label('title_ru', trans('messages.Craft title').'_RUS:') }}
        {{ Form::text('title_ru',Input::old('title',$craft->title_ru)) }}
    </div>
</div>
<div class="row">
    <div class="small-7 large-7 column">
        {{ Form::label('description_ru',trans('messages.Description').'_RUS:') }}
        {{ Form::textarea('description_ru',Input::old('description',$craft->description_ru),['rows'=>5]) }}
    </div>
</div>
<div class="row">
    <div class="small-7 large-7 column">
